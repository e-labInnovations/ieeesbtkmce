...
function Edit({
  ...
  const [currentItemPos, setCurrentItemPos] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useState)(-1);
  const isSelectedBlock = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
  ...
  const doNext = () => {
    ...
    // );
    setAttributes({
      activeItem: innerBlocks[newPosition].clientId
    });
  };

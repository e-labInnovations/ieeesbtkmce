/******/ (() => {
  ...
  document.querySelectorAll("nav").forEach((nav) => {
    ...
    nav
      .querySelectorAll("#dropdownNavbarLink")
      .forEach((dropdownNavbarLink) => {
        const linkParent = dropdownNavbarLink.parentElement;
        const currentDropdownNavbar =
          linkParent.querySelector("#dropdownNavbar");
        dropdownNavbarLink.addEventListener("mouseover", () => {
          if (currentDropdownNavbar.classList.contains("hidden")) {
            nav
              .querySelectorAll("#dropdownNavbar")
              .forEach((dropdownNavbar) => {

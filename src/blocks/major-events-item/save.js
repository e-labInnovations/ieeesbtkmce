export default function save({ attributes }) {
  return (
    <div className="slide mx-3 flex flex-col">
      <img
        src="https://picsum.photos/330/230?random=1"
        alt=""
        className="h-full w-full object-cover"
      />
      <div className="flex h-full w-full items-end justify-between gap-2 px-4 py-2">
        <div className="flex h-full flex-col self-start">
          <h3 className="mb-2 font-poppins text-base font-normal text-black">
            Lorem Ipsum
          </h3>
          <p className="line-clamp-2 font-poppins text-base font-light text-gray-500">
            Lorem ipsum dolor sit amet consectetur. Aenean ornare. Lorem ipsum
            dolor sit amet consectetur, adipisicing elit. Eos, animi temporibus
            quod sed aliquid dolorem assumenda ullam recusandae nemo neque
            perferendis! Consequatur fuga, tempora assumenda inventore eum ipsa
            excepturi tempore?
          </p>
        </div>

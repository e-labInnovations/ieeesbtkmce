            ...
            <div className="flex flex-col px-12 sm:flex-row sm:px-12 md:px-24 xl:px-48 ">
                ...
                />
                    ...
                    <div className="mt-8 flex flex-row sm:mt-8 md:mt-10 xl:mt-12">
                        <a href="#" className="rounded p-2 px-5 text-center text-primary-800 outline outline-1 outline-primary-800 transition-shadow hover:shadow-md hover:shadow-gray-400">More Details</a>
                    </div>
                </div>
            </div>
        </Fragment>

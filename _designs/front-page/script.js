...
const setSelectedQuestion = (faqBlock, qBlock) => {
  ...
  faqBlock.querySelectorAll(".faq-item-q").forEach((_qBlock) => {
    ...
    _qBlock
      .querySelector("svg")
      .classList.remove("rotate-180", "fill-primary-800");
    _qBlock.querySelector("svg").classList.add("rotate-0", "fill-gray-200");
  });

  qBlock.classList.remove("border-[1px]", "border-gray-800");
  qBlock.classList.add("border-[3px]", "border-primary-800");
  qBlock.querySelector("svg").classList.remove("rotate-0", "fill-gray-200");
  qBlock.querySelector("svg").classList.add("rotate-180", "fill-primary-800");
